...
class GovernanceAIAgent:
    ...
    def _load_default_config(self) -> AgentConfig:
        ...
        # Set skills base path to the repository's skills/ directory
        # From implementation/ go up 5 levels to repository root
        ...
        # Set skills path - all skills are now in the skills/ directory
